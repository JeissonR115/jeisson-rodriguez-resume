// CSS-fixed copy for design-sync — see .design-sync/synth-src/button/index.tsx
// header. Cross-component imports point at sibling synth-src copies (not the
// @/ aliased originals) because those still import .scss directly, which
// would break this file's own bundle entry. Data/types/context imports are
// safe via the real @/ alias — they carry no CSS.
...
import { iconSizes } from '../icon/icon.type.ts';
