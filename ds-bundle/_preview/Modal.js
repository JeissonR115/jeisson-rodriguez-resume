var __dsPreview = (() => {
  ...
  function Confirm() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(ds_exports.Modal, { isOpen: true, title: "Confirm", onClose: () => {
    }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Are you sure you want to delete this experiment?" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", gap: 8, marginTop: 16 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.Button, { variant: "primary", children: "Delete" }),
